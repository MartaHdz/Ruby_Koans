...
class AboutIteration < Neo::Koan
  ...
  def test_select_selects_certain_items_from_an_array
    ...
    even_numbers = array.select { |item| (item % 2) == 0 } # coge multiplos de 2
  ...
  def test_inject_will_blow_your_mind
    ...
    # Al valor que le das (0 o 1 en este caso) va realizando la operación q
    # le indicas o describes en el bloque con cada uno de los itms del array
  end

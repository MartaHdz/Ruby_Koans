...
# con el % estas definiendo unas comillas alternativas, para no tener
# que usar muchas secuencias de escape (\" o \').
...
It was the worst of times.
    ...
    assert_equal 54, long_string.length # cuenta los espacios y saltos de linea
...
#EOS significa "end of string" se usa para strings largos
  ...
  # se usan los valores de ASCII
  # https://es.wikipedia.org/wiki/ASCII#Los_caracteres_de_control_ASCII

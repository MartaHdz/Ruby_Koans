...
class AboutClasses < Neo::Koan
  ...
  def test_instance_variables_can_be_set_by_assigning_to_them
    ...
    fido.set_name("Fido") ## Fijarse bien que "set_name" esta definido en la clase Dog2
...
# representation of obj. When overriding this method, it should return a string

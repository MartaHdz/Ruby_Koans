...
# porque? {} es para el número de veces que aparezca, a lo mejor es para las
# veces que salga |a| y que siga el patron a[/[cbr]at] ([cbr] significa
# cualquiera de las opciones que aparecen )
  ...
  def test_slash_d_is_a_shortcut_for_a_digit_character_class
    ...
    assert_equal "42", "the number is 42"[/\d+/] #\d significa un caracter que sea
                                               # un dígito (número)
  end
  ...
  def test_period_is_a_shortcut_for_any_non_newline_character
    assert_equal "abc", "abc\n123"[/a.+/] # . significa "any character"
                                        # excepto una linea nueva
                                        # \n es una linea nueva?
  end
  ...
  def test_shortcut_character_classes_are_negated_with_capitals
    ...
    assert_equal " = ", "variable_1 = 42"[/[^a-zA-Z0-9_]+/] # incluye espacios
  ...
  def test_caret_anchors_to_the_start_of_lines
    assert_equal "2", "num 42\n2 lines"[/^\d+/] # ^ significa al inicio de lineas
                                                # \d es un digito
  end
